...
<section class="hero">
  <div>
    ...
    <p>Professional Quran education with Tajweed, Hifz and Islamic values — taught one-to-one.</p>
...
<section id="reviews" class="reviews reveal">
  ...
  <div class="slider">
    <div class="slides" id="slides">
      <div class="review">
        <div class="stars">★★★★★</div>
        <p>“My child improved a lot in Tajweed. Teachers are patient and professional.”</p>
        <h4>— Ayesha Khan</h4>
      </div>
      <div class="review">
        <div class="stars">★★★★★</div>
        <p>“Flexible timings and one-to-one classes helped me learn Quran easily.”</p>
        <h4>— Muhammad Umar</h4>
      </div>
      <div class="review">
        <div class="stars">★★★★★</div>
        <p>“Excellent online Quran academy. Highly recommended.”</p>
        <h4>— Sana Ali</h4>
      </div>
    </div>
  </div>
...
<a class="whatsapp" href="https://wa.me/923026910406">💬</a>
